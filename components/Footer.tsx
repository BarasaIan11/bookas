      ...
      content: (
        <div className="flex flex-col items-start gap-4">
          ...
          <p className="text-xs text-white/60 leading-relaxed max-w-xs">
            Professional home/office cleaning and car detailing in Machakos.
            Spotless results, every time, brought straight to your location.
          </p>
      ...
      content: (
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-white/60">
            <li>
              <button
                onClick={() => openModal("Interior Wash")}
            ...
            <li>
              <button
                onClick={() => openModal("Exterior Wash")}
                className="hover:text-sky-400 transition-colors text-left"
              >
                Exterior Wash
              </button>
            ...
            <li>
              <button
                onClick={() => openModal("Sofa Cleaning")}
                className="hover:text-sky-400 transition-colors text-left"
              >
                Sofa Cleaning
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          ...
          <p className="text-white/40 text-xs md:text-sm flex items-center gap-1 justify-center">
            ...
            <span>Innovition Solutions Limited</span>
